...
\begin{frame}{}
  \begin{center}
    ...
    \vspace{0.30cm}
    \red{\bf 基本思想:} 一个动作在它\blue{\bf 左边的}所有文法符号都处理过之后立刻执行
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    \blue{\bf $L$ 属性定义} 与 \blue{\bf $LL$ 语法分析}
...
\begin{frame}{}
  \begin{center}
    ...
    \vspace{0.80cm}
    计算 $X_{i}$ \red{\bf 继承属性}的动作放在产生式体 $X_{i}$ 的\blue{左边}

    \vspace{0.30cm}
    计算产生式头部 $A$ \red{\bf 综合属性}的动作放在产生式体的\blue{最右边}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
