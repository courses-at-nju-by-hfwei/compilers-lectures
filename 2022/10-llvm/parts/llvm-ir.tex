...
\begin{frame}{}
	...
	\begin{center}
		...
		\pause
		\vspace{0.30cm}
		\href{https://mapping-high-level-constructs-to-llvm-ir.readthedocs.io/en/latest/control-structures/ssa-phi.html}{Single-Static Assignment Form and \red{PHI}}
	\end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
