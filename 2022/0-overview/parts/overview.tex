...
%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
  \fig{width = 0.35\textwidth}{figs/knuth-chair}

  \vspace{0.30cm}
  \begin{quote}
    ``For his major contributions to \blue{the analysis of algorithms}
      and \red{the design of programming languages},
      and in particular for his contributions to ``\blue{The Art of Computer Programming}''
