...
\begin{frame}{}
  \begin{columns}
    \column{0.50\textwidth}
      \fig{width = 0.75\textwidth}{figs/instruction-selection}
    \column{0.50\textwidth}
      \fig{width = 0.80\textwidth}{figs/register-allocation}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%
\begin{frame}{}
  \fig{width = 0.60\textwidth}{figs/just-have-fun}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    \fig{width = 0.70\textwidth}{figs/cuijian}

    \pause
    \vspace{0.30cm}
    \teal{\href{https://www.bilibili.com/video/BV1bL4y1h7oy/?share_source=copy_web&vd_source=afddc1f6e07c3046ed07519aa34370fd}{\Large ``\texttt{因为我的病就是没有感觉}''}}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%