...
\begin{frame}{}
  \begin{center}
    \teal{\href{https://godbolt.org/z/MdYGMh8GG}{bubblesort @ CompilerExplorer}}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    \teal{\href{https://godbolt.org/z/b9dxE4vTM}{tree-node @ CompilerExplorer}}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{columns}
    \column{0.50\textwidth}
      \fig{width = 0.85\textwidth}{figs/computer-organization-book}
    \column{0.50\textwidth}
