...
\begin{frame}{}
  \begin{center}
    只学原理不行, 更重要的是 $\cdots$
    \fig{width = 0.40\textwidth}{figs/writing-a-c-compiler}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    ...
    \vspace{0.30cm}
    \blue{\texttt{gcc factorial.c -o factorial}}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.40\textwidth}
      \fig{width = 1.00\textwidth}{figs/riscv/riscv-logo}
      {\small (Reduced Instruction Set Computer)}
    \column{0.60\textwidth}
      \pause
      \begin{center}
        \red{\bf 隆重推荐} \url{https://godbolt.org/}
        \fig{width = 0.80\textwidth}{figs/compiler-explorer}
...
\begin{frame}{}
  \begin{center}
    \fig{width = 0.80\textwidth}{figs/riscv/riscv-org}
...
\begin{frame}{}
  \begin{columns}
    \column{0.50\textwidth}
      \begin{center}
        \fig{width = 0.80\textwidth}{figs/riscv/intro-riscv-book}
    ...
    \column{0.50\textwidth}
      \pause
      \begin{center}
        \fig{width = 0.70\textwidth}{figs/riscv/riscv-reader}
...
\begin{frame}{}
  \begin{center}
    ...
    \fig{width = 0.80\textwidth}{figs/riscv/rars}
...
\begin{frame}{}
  \begin{center}
    ...
    \vspace{0.30cm}
    \href{https://www.cs.unm.edu/~joel/PaperFoldingFractal/paper.html}{Fractal Grower (Play with It!)}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    \fig{width = 0.60\textwidth}{figs/triangle-construction}
...
\begin{frame}{}
  \begin{center}
    ...
    \vspace{0.30cm}
    \red{\bf L0:} \red{\bf 环境配置} 预计本周五 16:00 发布
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{columns}
    \column{0.50\textwidth}
      \fig{width = 0.40\textwidth}{figs/oj}
    \column{0.50\textwidth}
      \fig{width = 0.80\textwidth}{figs/oj-accounts}
  \end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    ...
    \begin{columns}
      \column{0.60\textwidth}
        \fig{width = 1.00\textwidth}{figs/zulip}
      \column{0.40\textwidth}
        \fig{width = 1.00\textwidth}{figs/zulip-qrcode}
    \end{columns}
