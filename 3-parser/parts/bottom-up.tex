...
\begin{frame}{}
  \begin{center}
    将\red{\bf $LR(0)$ 自动机} 表示成 \blue{\bf $LR(0)$ 分析表}
    ...
    \begin{columns}
      ...
      \column{0.50\textwidth}
        \fig{width = 0.95\textwidth}{figs/lr0-table-expr-add-mul}
    \end{columns}
...
\begin{frame}{}
  \begin{center}
    ...
    \begin{columns}
      ...
      \column{0.50\textwidth}
        \fig{width = 0.95\textwidth}{figs/lr0-table-expr-add-mul-reduce}
    \end{columns}

    \vspace{0.80cm}
    \blue{\bf 归约动作:} $A \to \alpha \cdot \in s$, 则有 $\action[s, \red{\bf a}] = r\_$

    \vspace{0.30cm}
    \red{\bf $a$:} 除了已经填入 $\action[s, \_] = s\_$ 的其余所有终结符
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    ...
    \fig{width = 0.70\textwidth}{figs/lr0-table-expr-add-mul-reduce-same}
