...
\begin{frame}{}
  \begin{center}
    ...
    \vspace{0.20cm}
    \red{\bf \goto{} 函数}被拆分成 \blue{\action{} 表} {\small (针对终结符)}
...
\begin{frame}{}
  \begin{center}
    \begin{enumerate}[(1)]
      \centering
      \item $[A \to \alpha \cdot a \beta] \land a \in T
        \land \goto(I_{i}, a) = I_{j} \implies \action[i, a] \gets sj$
    \end{enumerate}
    ...
    \begin{enumerate}[(2)]
      \centering
      \item $\goto(I_{i}, A) = I_{j} \implies \action[i, A] \gets gj$
    \end{enumerate}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    ...
    \begin{enumerate}[(3)]
      \centering
      \item $[k: A \to \alpha \cdot] \in I_{i} \land k > 0 \implies
        \forall t \in T \cup \set{\$}.\; \action[i, t] = rk$
    \end{enumerate}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{center}
    ...
    \begin{table}
      \centering
      \resizebox{0.45\width}{!}{\input{tables/lr0-table-expr}}
    \end{table}
...
\begin{frame}{}
  \begin{center}
    ...
    \begin{table}
      \centering
      \resizebox{0.60\width}{!}{\input{tables/lr0-table-expr}}
    \end{table}
