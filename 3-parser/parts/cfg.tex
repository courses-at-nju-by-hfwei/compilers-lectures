...
\begin{frame}{}
  ...
  \vspace{0.30cm}
  \begin{center}
    $L$-System (\blue{注: 这不是上下文无关文法, 但精神高度一致})
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  ...
  \begin{proof}
    \begin{center}
      ...
      \vspace{0.30cm}
      存在\blue{\bf 有限}状态自动机 $D(r)$: $L(D(r)) = L$; 设其状态数为 $k$
    \end{center}
  \end{proof}

  \begin{center}
    Pumping Lemma for \red{Regular Languages}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{}
  \begin{center}
    Pumping Lemma for \red{Context-free Languages}
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%%%%%